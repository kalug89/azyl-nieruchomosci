  ...
  <section id="page-billboard">
    <div class="container padding-medium-2 ">
      <div class="page-billboard-container text-center">
        <h1 class=" text-capitalize  lh-1 mb-3">O nas</h1>
        <!-- <span class="item"><a href="index.html">Home</a></span> &nbsp; / &nbsp; <span class="item">About Us</span> -->
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <div class="row justify-content-center">
        <div class="single-image col-lg-10 col-md-12">

          <h3 class="mb-4">
            Azyl Nieruchomości to miejsce, w którym doświadczenie, zaangażowanie i zaufanie spotykają się z realnymi
            potrzebami naszych klientów.
          </h3>

          <p>
            Wierzymy, że sprzedaż, zakup czy wynajem nieruchomości nie powinny być skomplikowanym i stresującym
            procesem.
            Dlatego jesteśmy po to, aby przeprowadzić Cię przez każdy jego etap - od pierwszej rozmowy aż po finalizację
            transakcji.
          </p>

          <p>
            Naszym celem jest tworzenie standardów obsługi, w których
            <strong>klient zawsze znajduje się na pierwszym miejscu</strong>.
            Słuchamy, doradzamy i szukamy najlepszych rozwiązań, zamiast kierować się utartymi schematami.
            Każdą nieruchomość traktujemy indywidualnie, bo wiemy, że za każdą transakcją stoi konkretna osoba,
            jej plany, emocje i często bardzo ważna życiowa decyzja.
          </p>

          <p class="fw-semibold mt-4">
            Ty określasz cel. My pomagamy znaleźć najlepszą drogę do jego realizacji.
          </p>
...
<h2 class="mb-4">Działamy na terenie całego Mazowsza</h2>
    ...
    <p class="obszar-dzialania__haslo mb-0">
      Mazowsze znamy lokalnie. Rynek rozumiemy szerzej.
          ...
          <p>
            Rynek nieruchomości nieustannie się zmienia. Zmieniają się ceny, oczekiwania klientów
            i sposoby prezentowania ofert. Dlatego nie stoimy w miejscu.
          </p>

          <p>
            Obserwujemy rynek, rozwijamy nasze kompetencje i wykorzystujemy nowoczesne rozwiązania,
            aby działać <strong>sprawnie, skutecznie i przede wszystkim z korzyścią dla naszych klientów</strong>.
          </p>

          <p>
            Nie ograniczamy się do wystawienia ogłoszenia i oczekiwania na telefon.
            Przygotowujemy nieruchomość do sprzedaży, dbamy o jej odpowiednią prezentację,
            docieramy do potencjalnych klientów, prowadzimy negocjacje i koordynujemy cały proces transakcji.
          </p>

          <h4 class="mt-4">
            Ty możesz spokojnie zająć się swoim życiem. My zajmiemy się Twoją nieruchomością.
          </h4>
          ...
          <p>
            Wartości wyznaczają sposób, w jaki działamy, podejmujemy decyzje i współpracujemy.
            To one kształtują kulturę naszej organizacji, wpływają na to, kogo zapraszamy do zespołu,
            i pomagają nam wspólnie mierzyć się z codziennymi wyzwaniami.
          </p>
          ...
          <p>
            Nieruchomość to często jedna z najważniejszych decyzji finansowych w życiu.
            Wiemy, jak dużym zaufaniem obdarzasz nas, powierzając nam swój majątek.
            Dlatego stawiamy na jasną komunikację, uczciwe zasady i pełną transparentność
          ...
          <p>
            Nie działamy po to, aby mieć jak najwięcej ofert.
            Działamy po to, aby osiągać konkretne rezultaty.
            Każde zlecenie traktujemy jako zobowiązanie, a naszym zadaniem jest doprowadzenie go
            do najlepszego możliwego finału.
          </p>
          ...
          <p>
            Nie ma dla nas „kolejnej nieruchomości”.
            Jest <strong>Twoja nieruchomość</strong> i Twój cel.
            Dlatego angażujemy się w każde powierzone nam zadanie i szukamy rozwiązań również wtedy,
            gdy sytuacja wymaga nieszablonowego podejścia.
          </p>
          ...
          <p>
            Wiemy, że transakcje nieruchomościowe wiążą się z dużymi pieniędzmi i jeszcze większymi emocjami.
            Dbamy o szczegóły, dokumentację i prawidłowy przebieg procesu, abyś na każdym etapie wiedział,
          ...
          <p>
            Nieustannie podnosimy swoje kompetencje i śledzimy zmiany zachodzące na rynku.
            Korzystamy ze sprawdzonych narzędzi i nowoczesnych metod prezentacji nieruchomości,
            ponieważ wierzymy, że profesjonalna obsługa zaczyna się od wiedzy i kończy na jakości wykonania.
          </p>
          ...
          <p>
            Nie wierzymy w gotowe rozwiązania dla każdego.
            Inaczej wygląda sprzedaż mieszkania, inaczej domu, działki czy nieruchomości inwestycyjnej.
            Dlatego najpierw poznajemy Twoją sytuację i cel, a dopiero później proponujemy konkretne działania.
          </p>
          ...
          <p>
            Jeżeli widzimy możliwość osiągnięcia lepszego rezultatu - powiemy Ci o niej.
            Jeżeli dostrzegamy ryzyko - również o nim powiemy.
            <strong>Nie obiecujemy tego, czego nie możemy zagwarantować.</strong>
            Zależy nam na relacji, która nie kończy się wraz z podpisaniem umowy.
          </p>
          ...
          <p>
            Powierzenie nam nieruchomości oznacza dla nas realną odpowiedzialność.
            Pilnujemy terminów, odpowiadamy na pytania, jesteśmy w kontakcie i dbamy o każdy szczegół.
            Chcemy, abyś miał pewność, że Twoja sprawa jest w dobrych rękach.
          </p>
          ...
          <h2 class="mb-4">
            Azyl - spokojnie przez cały proces
          </h2>

          <p>
            Nazwa <strong>Azyl</strong> nie jest przypadkowa.
            Chcemy, aby współpraca z nami była właśnie takim miejscem - spokojnym,
            bezpiecznym i opartym na zaufaniu.
          </p>

          <p>
            Rynek nieruchomości potrafi być wymagający.
            My bierzemy na siebie jego złożoność, negocjacje, formalności i organizację procesu,
            aby Tobie pozostało to, co najważniejsze -
            <strong>spokojne podejmowanie decyzji.</strong>
          </p>

          <h4 class="mt-5 mb-5">
            Azyl Nieruchomości - Twoja nieruchomość. Nasze zaangażowanie. Wspólny cel.
          </h4>
  ...
  <div class="row mt-4">
    <div class="col"><img class="abt-img img-fluid rounded-4" src="images/item7.jpg" alt="About us" /></div>
    <div class="col"><img class="abt-img img-fluid rounded-4" src="images/item8.jpg" alt="About us" /></div>
    <div class="col"><img class="abt-img img-fluid rounded-4" src="images/item9.jpg" alt="About us" /></div>
  </div>
  <div class="row">
    <!-- <div class="col-md-12 mt-5">
          <h2 class="mt-5 mb-3">Motto</h2>
          <p>
    ...
    <div class="container">
      <div class="row">
        <div class="text-center col-lg-4">
          <i class="bi bi-search text-primary display-2"></i>
          <h3 class="my-3">Dopasowane oferty</h3>
          <p>Pomagamy znaleźć nieruchomość idealnie dopasowaną do Twoich potrzeb i oczekiwań.</p>
        </div>
        <div class="text-center col-lg-4">
          <i class="bi bi-tags text-primary display-2"></i>
          <h3 class="my-3">Jasne warunki</h3>
          <p>Przejrzysta współpraca, bez ukrytych kosztów i niedomówień.</p>
        </div>
        <div class="text-center col-lg-4">
          <i class="bi bi-stopwatch text-primary display-2"></i>
          <h3 class="my-3 ">Sprawny proces</h3>
          <p>Pomagamy przejść przez zakup, sprzedaż lub wynajem krok po kroku. </p>
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- Help start  -->
  <!-- <section id="help" class="padding-medium">
        ...
        <div class="col-md-6">
          <div class="text-content ps-md-5 mt-4 mt-md-0">
            ...
            <ul class="list-unstyled">
              <li>✓ Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem vero maiores assumenda!</li>
              <li>✓ Odit similique voluptas excepturi doloribus eius aliquid neque, aut illo blanditiis.</li>
              <li>✓ Quae iusto excepturi quasi ipsum, non ab iure error nam pariatur distinctio temporibus.</li>
              <li>✓ Odit similique voluptas excepturi doloribus eius aliquid neque, aut illo blanditiis.</li>
              <li>✓ Quae iusto excepturi quasi ipsum, non ab iure error nam pariatur distinctio temporibus.</li>
            </ul>
          ...
          <div class="swiper testimonial-swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <svg class="text-primary" width="120" height="120">
                  <use xlink:href="#quote"></use>
                </svg>
                <p class="testimonial-p mt-2">Massa semper non rutrum orci facilisi sit. Lectus porta quam a fringilla
                  eget viverra sem. Vulputate massa hendrerit turpis gravida tempor, porttitor.</p>
                <div class="row">
                  <div class="col-md-8">
                    <p class="fw-semibold pt-3 mb-1">Elena Pravo</p>
                    <p class="text-primary opacity-75">Ceo, Upstate</p>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
  ...
  <!-- Post start  -->
  <!-- <section id="post" class="padding-medium">
      <div class="container-fluid px-md-5">
        <div class="section-header d-flex align-items-center justify-content-between  mb-5">
          <h2 class="section-title">Related Posts</h2>
          <a href="contact.html" class="btn btn-primary btn-lg px-4 me-md-2">Read More</a>
        </div>
        <div class="row">
          <div class="col-md-4">
            <article class="post-item pb-5">
              <div class="post-image">
                <a href="single-post.html"><img src="images/item-large3.jpg" class="img-fluid rounded-4"></a>
              </div>
          ...
          <div class="col-md-4">
            <article class="post-item pb-5">
              <div class="post-image">
                <a href="single-post.html"><img src="images/item-large6.jpg" class="img-fluid rounded-4"></a>
              </div>
              <div class="post-content">
                <a href="#" class="text-decoration-none">
                  <p class="blog-topic text-uppercase mt-3">Rent / 12 jan, 2022</p>
          ...
          <div class="col-md-4">
            <article class="post-item pb-5">
              <div class="post-image">
                <a href="single-post.html"><img src="images/item-large8.jpg" class="img-fluid rounded-4"></a>
              </div>
              <div class="post-content">
                <a href="#" class="text-decoration-none">
                  <p class="blog-topic text-uppercase mt-3">Rent / 12 jan, 2022</p>
