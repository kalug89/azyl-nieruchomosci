  ...
  <section id="page-billboard">
    <div class="container padding-medium-2 ">
      <div class="page-billboard-container text-center">
        <h1 class=" text-capitalize  lh-1 mb-3">Działki</h1>
        <span class="item"><a href="index.php">Home</a></span> &nbsp; / &nbsp; <span class="item">Działki</span>
      </div>
    </div>
  </section>
          ...
          <div class="card">
            ...
            <div class="card-body p-0">
              ...
              <a href="dzialka_nr1.php">
                <h4 class="card-title">Pakiet czterech działek</h4>
              </a>
                ...
                <ul class="d-flex">
                  <li class="residence-list pe-2 fw-semibold">
                    <svg class="text-primary" width="30" height="30">
                      <use xlink:href="#house-gear"></use>
                    </svg> Media w drodze
                  </li>
                  <li class="residence-list pe-2 fw-semibold">
                    <svg class="text-primary" width="30" height="30">
                      <use xlink:href="#bath"></use>
                    </svg> warunki zabudowy
