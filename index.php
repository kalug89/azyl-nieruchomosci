...
<head>
  ...
  <title>Azyl - nowoczesne biuro nieruchomości </title>
...
<body data-bs-spy="scroll" data-bs-target="#navbar-example2" tabindex="0">
  ...
  <section id="billboard"
    style="background: url(images/billboard.jpg); background-repeat: no-repeat; background-position: center; height:960px;">
    ...
    <div class="container-fluid px-md-5">
      ...
      <div class="row d-flex justify-content-between align-items-center">
       ...
       <ul class="list-unstyled fs-5 lh-base d-flex flex-column gap-3">
              ...
              <li>✓ Przejrzysta komunikacja na każdym etapie</li>
              <li>✓ Bezpieczeństwo formalne i organizacyjne</li>
            </ul>
            <a href="kontakt.php" class="btn btn-primary btn-lg mt-4">Skontaktuj się z nami</a>
          </div>
        </div>
          ...
          <div class="swiper testimonial-swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                ...
                <p class="testimonial-p mt-2">Azyl Nieruchomości powstał z myślą o osobach, które chcą podejmować decyzje spokojnie i świadomie. Pomagamy znaleźć nie tylko adres, ale miejsce, w którym naprawdę można poczuć się u siebie.</p>
                <div class="row">
                  <div class="col-md-8">
                    <p class="fw-semibold pt-3 mb-1">Azyl Nieruchomości</p>
                    <p class="text-primary opacity-75">Biuro nieruchomości</p>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
