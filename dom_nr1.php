...
<body data-bs-spy="scroll" data-bs-target="#navbar-example2" tabindex="0">
  ...
  <section id="page-billboard">
    <div class="container padding-medium-2 ">
      <div class="page-billboard-container text-center">
        <div class="my-3 ">
          <h1 class=" text-capitalize lh-1 mb-4">Designerski dom klasy premium z prywatnym ogrodem | 244 m² | Piastów
          </h1>
          <div class="d-flex justify-content-center">
            <p class="fs-5 ">Piastów, przy granicy z Warszawą</p>
            <p class="text-primary">&nbsp; | &nbsp;</p>
            <p class="fs-5 fw-semibold"> Na sprzedaż</p>
            <p class="text-primary">&nbsp; | &nbsp;</p>
            <p class="fs-5 fw-semibold"> Cena: 3 600 001 zł</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <main class="post-grid col-md-9 mx-auto">
        <div class="row">
