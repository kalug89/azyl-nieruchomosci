          ...
          <article class="property">
            ...
            <div class="post-content py-5">
              ...
              <div class="details my-5">
                ...
                <p> <span class="fw-bold">Przeznaczenie : </span> Dla każdej działki zostały wydane warunki zabudowy na budowę domu jednorodzinnego.</p>
                <p> <span class="fw-bold">Dostęp do drogi: : </span>Każda działka posiada bezpośredni dostęp do drogi.</p>
                <p> <span class="fw-bold">Media :</span> Media znajdują się w drodze, a skrzynki przyłączeniowe są zlokalizowane przy działkach.</p>
      ...
      <aside class="col-md-3">
        <form id="form" class="form-group flex-wrap border rounded-4 p-3">
          ...
          <div class="form-input col-lg-12 my-4">
            <label for="exampleInputEmail1" class="form-label fs-6 text-uppercase fw-bold text-black">Full
              Name</label>
          ...
          <div class="col-lg-12 my-4">
            <label for="exampleInputEmail1" class="form-label fs-6 text-uppercase fw-bold text-black">Phone
              Number</label>
            <input type="text" name="email" placeholder="Phone Number" class="form-control ps-3">
          </div>
          <div class="col-lg-12 my-4">
            <label for="exampleInputEmail1" class="form-label fs-6 text-uppercase fw-bold text-black">Family
              Members</label>
            <input type="number" value="1" name="quantity" class="form-control ps-3">
          </div>
          <div class="col-lg-12 my-4">
            <label for="exampleInputEmail1" class="form-label fs-6 text-uppercase fw-bold text-black">Children</label>
            <input type="number" value="1" name="quantity" class="form-control ps-3">
          </div>
          <div class="col-lg-12 my-4">
            <label for="exampleInputEmail1" class="form-label fs-6 text-uppercase fw-bold text-black">Your
              Message</label>
        ...
        <div class="border rounded-4 p-3 mt-5">
          ...
          <div class="d-grid mb-3">
            <a href="agents.html" class="btn btn-primary btn-lg text-uppercase btn-rounded-none">Contact Now</a>
          </div>
        </div>
      </aside>
    </div>
